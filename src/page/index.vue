...
import mgButton from '@/package/mg-button/src/mg-button.vue';
import mgInput from '@/package/mg-input/src/mg-input.vue';
import mgSbutton from '@/package/mg-sbutton/src/MgSbutton.vue';
...
<template>
    <div :class="{ card: flag }">
       ...
       {{ flag }}
       <mgInput @getCount="getCount" :listResult1="flag" v-slot:mySlot="{ value }">
        {{ count }}
       </mgInput>
       <mg-sbutton></mg-sbutton>
    </div>
</template>
<style scoped></style>